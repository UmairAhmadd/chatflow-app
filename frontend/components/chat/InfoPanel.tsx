...
export function InfoPanel({
  ...
  if (!room) {
    ...
    return (
      <aside
        className={cn(
          "w-[16%] min-w-[220px] min-h-0 flex-col overflow-y-auto border-l border-gray-200 bg-white px-5 py-6 dark:border-border dark:bg-surface",
          className
        )}
      >
  ...
  return (
    <aside
      className={cn(
        "w-[16%] min-w-[220px] min-h-0 flex-col overflow-y-auto border-l border-gray-200 bg-white dark:border-border dark:bg-surface",
        className
      )}
    >
      {/* Contact header */}

...
export default function AuthLayout({
  ...
  return (
    ...
    <div className="flex min-h-screen bg-[#080808]">
      ...
      <div className="flex flex-[0_0_50%] flex-col items-center justify-center px-3 py-6 lg:flex-1 lg:px-6 lg:py-12">
      ...
      <div className="flex flex-[0_0_50%] flex-col items-center overflow-hidden lg:flex-1">
        {/* Heading */}
